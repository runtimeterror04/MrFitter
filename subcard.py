...
def abs_wind(img1, img2,img3, img4, img5, img6, img7):
    ...
    if is_item_visible(window_name) == None:
        ...
        add_text(text)
        add_drawing("drawing_4", width=1080, height=200)
        draw_image("drawing_4", img7, [75, 0], pmax=[375,180], uv_min=[0, 0], uv_max=[1, 1])
...
def legs_wind(img1, img2,img3, img4, img5, img6, img7, img8, img9, img10):
    ...
    if is_item_visible(window_name) == None:
        ...
        draw_image("drawing_2", img3, [0,0], pmax=[235,150], uv_min=[0, 0], uv_max=[1, 1])
        draw_image("drawing_2", img4, [245,0], pmax=[485,150], uv_min=[0, 0], uv_max=[1, 1])
        draw_image("drawing_2", img5, [495,0], pmax=[735,150], uv_min=[0, 0], uv_max=[1, 1])
        text = extractingText(pathcsv, "lunges")
        add_text(text)
        add_spacing(count=20)
        add_drawing("drawing_3", width=1080, height=200)
        draw_image("drawing_3", img6, [0,0], pmax=[180,160], uv_min=[0, 0], uv_max=[1, 1])
        draw_image("drawing_3", img7, [210,0], pmax=[390,160], uv_min=[0, 0], uv_max=[1, 1])
        draw_image("drawing_3", img8, [420,0], pmax=[600,160], uv_min=[0, 0], uv_max=[1, 1])
        text = extractingText(pathcsv, "side lunges")
        add_text(text)
        add_spacing(count=20)
        add_drawing("drawing_4", width=1080, height=200)
        draw_image("drawing_4", img9,[0,0], pmax=[245,180], uv_min=[0, 0], uv_max=[1, 1])
        draw_image("drawing_4", img10, [255,0], pmax=[505,180], uv_min=[0, 0], uv_max=[1, 1])
...
def shoulder_wind(img1, img2,img3, img4, img5, img6):
    ...
    if is_item_visible(window_name) == None:
        ...
        add_spacing(count=20)
        add_drawing("drawing_2", width=1080, height=200)
        draw_image("drawing_2", img3, [0,0], pmax=[225,200], uv_min=[0, 0], uv_max=[1, 1])
        draw_image("drawing_2", img4, [245,0], pmax=[475,200], uv_min=[0, 0], uv_max=[1, 1])
...
def back_wind(img1, img2,img3, img4, img5, img6, img7, img8):
    ...
    if is_item_visible(window_name) == None:
        ...
        add_text(text)
        add_spacing(count=20)
        add_drawing("drawing_2", width=1080, height=220)
        draw_image("drawing_2", img3, [0,0], pmax=[225,220], uv_min=[0, 0], uv_max=[1, 1])
        draw_image("drawing_2", img4, [245,0], pmax=[475,220], uv_min=[0, 0], uv_max=[1, 1])
        text = extractingText(pathcsv, "chinup")
        add_text(text)
        add_spacing(count=20)
        add_drawing("drawing_3", width=1080, height=200)
        draw_image("drawing_3", img5, [0,0], pmax=[235,180], uv_min=[0, 0], uv_max=[1, 1])
        draw_image("drawing_3", img6, [245,0], pmax=[485,180], uv_min=[0, 0], uv_max=[1, 1])
        text = extractingText(pathcsv, "pullup")
        add_text(text)
        add_spacing(count=20)
        add_drawing("drawing_4", width=1080, height=155)
        draw_image("drawing_4", img7, [0,0], pmax=[390,150], uv_min=[0, 0], uv_max=[1, 1])
        add_drawing("drawing_5", width=1080, height=155)
        draw_image("drawing_5", img8, [0,0], pmax=[390,150], uv_min=[0, 0], uv_max=[1, 1])
